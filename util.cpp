...
char *formatTime(int ms)
{
    ...
    char *time = reinterpret_cast<char*>(malloc(9 * sizeof(char)));
    if (hours > 0)
...
void InitializeSDL(SDL_Window **window, SDL_Renderer **renderer, const char *TITLE, int WIDTH, int HEIGHT, const char *ICON_PATH)
{
